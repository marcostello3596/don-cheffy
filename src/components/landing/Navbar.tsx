...
const Navbar = () => {
  ...
  const handleLanguageToggle = () => {
    ...
    const legalPaths = ["/privacy", "/terms", "/support", "/account-deletion"];
    const esLegalPaths = ["/es/privacy", "/es/terms", "/es/support", "/es/account-deletion"];

    if (legalPaths.includes(path)) {
      navigate(`/es${path}`);
    } else if (esLegalPaths.includes(path)) {

...
import { termsOfUse } from "./legal/legalContents";
import Navbar from "@/components/landing/Navbar";
import Footer from "@/components/landing/Footer";

const Terms = ({ lang }: { lang: "en" | "es" }) => {
  ...
  const pageTitle = lang === "es" ? "Términos de Uso | ReciList" : "Terms of Use | ReciList";
  const pageDescription = lang === "es"
    ? "Términos y condiciones que rigen el uso de ReciList, incluyendo suscripciones, IA y exenciones de responsabilidad."
    : "Terms and conditions governing your use of ReciList, including subscriptions, AI use, and liability disclaimers.";
  const canonicalUrl = `https://recilist.app${lang === "es" ? "/es" : ""}/terms`;
